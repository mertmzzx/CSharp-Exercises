...
public class StartUp
{
    ...
    public static string ExportAlbumsInfo(MusicHubDbContext context, int producerId)
    {
        ...
        // Formatting of numbers in the .Select() gives you data ready to fill a ViewModel
        // This ViewModel can b e passed to any View
        var albumsInfo = context.Albums
            .Where(a => a.ProducerId.HasValue &&
                        a.ProducerId.Value == producerId)
            .ToArray() // This is because of a bug in EF 
