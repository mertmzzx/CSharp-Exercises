namespace VehiclesExtension
{
    ...
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Vehicle truck = vehicleFactory.CreateVehicle(truckData[0], double.Parse(truckData[1]), double.Parse(truckData[2]), double.Parse(carData[3]));
            Vehicle bus = vehicleFactory.CreateVehicle(busData[0], double.Parse(busData[1]), double.Parse(busData[2]), double.Parse(carData[3]));
